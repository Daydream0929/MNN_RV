...
#include "CSINN2Convolution.hpp"

namespace MNN {


CSINN2Convolution::CSINN2Convolution(MNN::Backend *b, const MNN::Op *mop, const std::vector<Tensor *> &inputs, const std::vector<MNN::Tensor *> &outputs) : CSINN2CommonExecution(b, op) {
...
ErrorCode CSINN2Convolution::onResize(const std::vector<Tensor *> &inputs, const std::vector<Tensor *> &outputs) {
...
REGISTER_CSINN2_OP_CREATOR(CSINN2Convolution, OpType_Convolution)
REGISTER_CSINN2_OP_CREATOR(CSINN2Convolution, OpType_ConvolutionDepthwise)
REGISTER_CSINN2_OP_CREATOR(CSINN2Convolution, OpType_Deconvolution)
} // namespace MNN
